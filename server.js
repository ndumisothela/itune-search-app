...
const axios =('axios'); // Import Axios for making HTTP requests to external services
...
const helmet = require('helmet'); // Import Helmet to secure Express app by setting various HTTP headers
...
app.use(helmet()); // Adds Helmet to enhance security
